...
*{box-sizing:border-box}html,body{height:100%;margin:0}body{min-height:100dvh;background:linear-gradient(180deg,#faf9f5 0%,#f1efe8 100%)}body.hide-traces .msg.trace{display:none}
...
.controls{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.controls button{min-height:36px;border-radius:14px;background:#fbfaf7;color:#111;border:1px solid #d8d2c5;padding:0 12px;font-weight:800;font-size:12px}.traceToggle{min-height:36px;border-radius:14px;background:#fbfaf7;color:#111;border:1px solid #d8d2c5;padding:0 12px;font-weight:800;font-size:12px;display:inline-flex;align-items:center;gap:7px;cursor:pointer}.traceToggle input{accent-color:#111}
