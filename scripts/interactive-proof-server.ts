...
.controls{display:flex;gap:8px}.controls button{min-height:36px;border-radius:14px;background:#fbfaf7;color:#111;border:1px solid #d8d2c5;padding:0 12px;font-weight:800;font-size:12px}
...
<main class="app">
  <header class="top" aria-label="machine summary">
    ...
    <div class="controls"><button id="stopBox" type="button">Pause Box now</button></div>
  </header>
