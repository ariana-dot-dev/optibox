...
.composer{position:relative;display:block;padding:16px;border-top:1px solid #e0e0e0;background:rgba(255,255,255,.97);backdrop-filter:blur(12px)}textarea{width:100%;min-height:58px;max-height:140px;resize:none;border:1px solid #d9d9d9;background:#fff;color:#111;padding:13px 66px 13px 15px;font:inherit;font-weight:400;outline:none;display:block;border-radius:16px}textarea:focus{border-color:#111}button{min-height:42px;border:0;background:#111;color:#fff;padding:0 16px;font:inherit;font-weight:400;cursor:pointer;border-radius:9px}button:disabled{opacity:.5;cursor:not-allowed}#send{position:absolute;right:23px;bottom:23px;width:44px;height:44px;min-height:44px;padding:0;background:#fc4b55;color:#fff;border:1px solid #fc4b55;border-radius:50%;display:flex;align-items:center;justify-content:center}#send svg{width:20px;height:20px;display:block}
...
.node{position:relative;z-index:1;border:1px solid #e0e0e0;background:#f6f6f6;padding:12px 13px;border-radius:9px;transition:border-color .25s ease,background .25s ease,color .25s ease}.node .nodeTitle{display:block;font-size:14px;font-weight:400;color:inherit}.node .nodeSub{display:block;margin-top:3px;color:#666;font-size:11.5px;font-weight:400}
...
.packet{position:absolute;left:0;top:0;z-index:3;line-height:1;transform:translate(-50%,-50%);opacity:0;transition:top .45s cubic-bezier(.5,0,.2,1),left .45s cubic-bezier(.5,0,.2,1),opacity .25s ease;pointer-events:none;filter:drop-shadow(0 2px 5px rgba(0,0,0,.22));color:#111;background:#fff;border:1px solid #e0e0e0;border-radius:50%;width:26px;height:26px;display:flex;align-items:center;justify-content:center}.packet svg{width:14px;height:14px;display:block}.packet[data-kind="ok"]{color:#1a7f37;border-color:#1a7f37}.packet[data-kind="warn"]{color:#b54708;border-color:#b54708}
